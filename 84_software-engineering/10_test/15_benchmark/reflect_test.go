...
// go test reflect_test.go -test.bench=".*"  # for all functions
// go test reflect_test.go -test.bench="BenchmarkReflect_New" # for the 'BenchmarkReflect_New' function

// Ref: https://segmentfault.com/a/1190000018471470